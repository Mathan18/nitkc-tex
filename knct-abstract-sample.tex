...
\usepackage{knct-abstract}
\usepackage{graphicx}
%% \usepackage[dviout]{graphicx} %% for windows
...
%% 表題 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Associate	%% 卒業研究論文梗概の場合
%\Bachelor	%% 特別研究論文梗概の場合
%\Seminar	%% 特別研究セミナー論文梗概の場合
%\Master	%% 修士学位論文梗概の場合
%\Doctorate	%% 博士学位論文梗概の場合
%\English	%% 英語の場合

\Eyears{2014}
\Etitle{English Title}
%\idnumber{}  %% 学籍番号か卒業期・学科を記載する
\Eauthor{TAKECHI, Hanpeita}
\Eaffiliate{Ryouma Lab.}

%% 表題 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\years{平成26}
\title{卒業研究概要集用フォーマット}
\idnumber{47E} %% 学籍番号か卒業期・学科を記載する
\author{武市 ~半平太}
\affiliate{竜馬研究室}
...
%\setcounter{page}{100}
%\thispagestyle{plain}
%\renewcommand{\thepage}{-- \arabic{page} --}  %%番号の両側に‐を付けたいとき
%% 本文 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\begin{Abstract}
