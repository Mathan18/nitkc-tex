...
% \usepackage[relfont, usecmapforalphabet, noalphabet]{pxchfon}
...
% msフォント導入
\setmediumminchofont{msmincho.ttc} % \mcfamily\mdseries
\setboldgothicfont{msgothic.ttc} % \mcfamily\mdseries
